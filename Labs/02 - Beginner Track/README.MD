...
From Security Center **Overview** blade, under **Resource Security Hygiene**, you can also select recommendations per resource type: <br>
...
Explore the different recommendations and remediation steps, for example for your Win-0 and disk encryption:
![alt text](https://raw.githubusercontent.com/tianderturpijn/Azure-Security-Center/master/Labs/02%20-%20Beginner%20Track/Screenshots/recommendations2.png
)<br><br>
